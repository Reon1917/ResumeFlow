    ...
    <section className="py-16 sm:py-24 bg-gradient-to-r from-indigo-600 to-purple-600">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl sm:text-2xl text-indigo-100 mb-8 leading-relaxed">
          Join thousands of professionals who have transformed their careers with AI-powered 
          resume optimization and interview preparation.
        </p>

        {/* Value Reinforcement */}
        <div className="flex flex-wrap justify-center gap-6 mb-10 text-indigo-100">
        ...
        <div className="mt-6">
          <p className="text-indigo-200 text-sm">
            🔥 Limited time: Get premium features free for your first analysis
          </p>
        </div>
      </div>
    </section>
